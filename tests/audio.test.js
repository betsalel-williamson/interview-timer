...
describe('AudioManager', () => {
  ...
  describe('playAlert', () => {
    ...
    it('should set oscillator frequency with exponential ramp for gentle chirp pattern', async () => {
      await audioManager.playAlert();
      ...
      ).toHaveBeenCalledWith(600, 0.15);
      expect(
        mockOscillator.frequency.exponentialRampToValueAtTime
      ).toHaveBeenCalledWith(500, 0.3);
    });

    it('should configure gain envelope for 0.35-second duration with gentle volume', async () => {
      await audioManager.playAlert();
      ...
      expect(mockGainNode.gain.setValueAtTime).toHaveBeenCalledWith(0.08, 0.25);
      expect(mockGainNode.gain.linearRampToValueAtTime).toHaveBeenCalledWith(
        0,
        0.35
      );
    ...
    it('should start and stop oscillator with correct timing', async () => {
      ...
      expect(mockOscillator.stop).toHaveBeenCalledWith(0.35);
    });
